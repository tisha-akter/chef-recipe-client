...
const Footer = () => {
    return (
        <div className='container mx-auto' >
            <footer  className="footer footer-center p-10 bg-indigo-200 text-black-content mb-0">
                <div>
                    ...
                    Social <span className="text-5xl font-bold text-orange-500  "> Chef</span>
                    </h1>
                    <h3 className="text-xl font-bold">Providing healthy and unique food since 1992</h3>
